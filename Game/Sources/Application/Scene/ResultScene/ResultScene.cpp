...
void ResultScene::ResourceLoad()
{
	...
	sprite->SetPos({ 0,100 });
	sprite->SetRectangle({ 0,0,696,103 });
	...
	m_bgm = AudioManager::GetInstance().Play("Assets/Sounds/Result.wav", true);
...
void ResultScene::Init()
{
	...
	std::thread thread(&ResultScene::ResourceLoad, this);
	thread.detach();
}
